...
const App = ({ navigation }) => {
  ...
  const updateLayout = (index) => {
    ...
    setActivitycontent(array);
  };

  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        {activitycontent.map((item, key) => (
          <ExpandableComponent
...
const CONTENT = [
  ...
  },
  {
    ...
    subcategory: [
      { id: 1, val: "Spoken English" },
      { id: 2, val: "Mental Math" },
      { id: 3, val: "Whiz Kid" },
    ],
  },
  {
  ...
  },
  {
    ...
    subcategory: [
      { id: 10, val: "Self Defence" },
      { id: 11, val: "Foreign Language" },
      { id: 12, val: "Yoga" },
    ],
  },
  {
